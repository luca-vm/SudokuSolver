...
{    
    ...
    {       
        ...
        {
            int colIn, currRow = i / (25 * 25), currCol = (i / 25) % 25, off = i % 25;
            ...
            for (int j = 0; j < 4; j++) 
            {
               ...
               switch (j)
                ...
                case 0: 
                    ...
                    break;
                case 1: 
                    colIn = n + (currRow * 25) + off;
                    break;
                case 2: 
                    colIn = startCol + off + ((i / 25) % 25) * 25;
                    break;
                case 3: 
                    colIn = startCol + off + (box[i]Width * (currRow / box[i]Width) + (currCol / box[i]Width)) * 25 ;
                    break;
                } 
